...
def generate_launch_description():
    ...
    turtlebot3_multi_robot = get_package_share_directory('inter_iit')

    package_dir = get_package_share_directory('inter_iit')
    ...
    world = os.path.join(
        get_package_share_directory('inter_iit'),
        'worlds', 'world_easy.world')

...
def generate_launch_description():
    ...
    for robot_type, robot_list in robots_config.items():
        ...
        for i, robot in enumerate(robot_list):
            if robot_type == 'robot1':  # Handle robot1 type
                ...
                spawn_robots.append(spawn_robot_group(robot['name'], i, robot['x'], robot['y'], robot['z'], 2))
    ...
    ld.add_action(DeclareLaunchArgument('world', default_value=os.path.join(bringup_dir, 'worlds', 'factory.world'), description='World file'))
